...
export class StudentService {
  ...
  getAll(): Observable<Student[]> {
    return this.httpClient.get<Student[]>(this.apiURL + '/api/employees')
    .pipe(
  ...
  create(post: Student): Observable<Student> {
    return this.httpClient.post<Student>(this.apiURL + '/api/employees/add', JSON.stringify(post), this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }  
